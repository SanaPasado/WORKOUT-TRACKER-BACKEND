...
urlpatterns = [
    ...
    path('premium/paypal/create-order/', views.paypal_create_order, name='paypal-create-order'),
    path('premium/paypal/capture-order/', views.paypal_capture_order, name='paypal-capture-order'),
